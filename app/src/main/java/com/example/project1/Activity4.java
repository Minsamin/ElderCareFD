...
import com.example.FoodSearchQuery;
import com.example.type.FoodmenuSearchCriteriaInput;
...
public class Activity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ApolloClient apolloClient = ApolloClient.builder().serverUrl(BASE_URL).build();


        Log.e(TAG, "apolloClient Calling");


        FoodmenuSearchCriteriaInput input = FoodmenuSearchCriteriaInput.builder()
                //.id(3L)
                .activeFlag("Y")
                .build();

//        PeopleFragment peopleFragment =  ApiClient.getClient().apolloStore().read(
//                new PeopleFragment.Mapper(),
//                //CacheKey.from("QUERY_ROOT"),
//                null
//        ).execute();


        FoodSearchQuery dd = new FoodSearchQuery(new Input<>(input, false));
        dd.composeRequestBody(false, false, ScalarTypeAdapters.DEFAULT);
        //dd.variables()
